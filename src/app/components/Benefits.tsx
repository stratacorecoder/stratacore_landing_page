...
export function Benefits() {
  return (
    <section id="benefits" className="relative overflow-x-clip px-4 py-16 sm:px-6 sm:py-20 md:px-8 md:py-28 lg:px-12">
      <div className="mx-auto max-w-7xl">
        <div className="grid items-start gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-20">
          <ScrollReveal className="space-y-4 sm:space-y-5 lg:sticky lg:top-28">
          ...
          <StaggerReveal className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6">
            {benefits.map((benefit) => (
              <div
                key={benefit.title}
                className="stagger-item space-y-3 rounded-2xl border border-violet-500/35 bg-[#09090B]/60 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md transition-colors duration-300 hover:border-violet-400/50 hover:bg-[#09090B]/70 sm:p-6"
              >
