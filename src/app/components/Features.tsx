    ...
    <PageSection id="features">
      ...
      <StaggerReveal className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3">
        {features.map((feature) => (
          <div
            key={feature.title}
            className={`stagger-item group relative flex h-full min-w-0 flex-col overflow-hidden rounded-2xl border bg-[#09090B]/55 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md transition-colors duration-300 sm:p-8 ${
              feature.accent
          ...
          >
            <div className="relative flex min-w-0 flex-1 flex-col space-y-5">
              <div
              ...
              <div className="min-w-0 space-y-2.5">
                ...
                <p className="text-base leading-relaxed text-zinc-300">{feature.description}</p>
              </div>
            </div>
          </div>
        ))}
