...
export function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative flex min-h-dvh w-full min-w-0 flex-col overflow-hidden pb-[env(safe-area-inset-bottom,0px)]"
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <video
          ...
          muted
          playsInline
          className="h-full w-full max-w-none object-cover object-[70%_center] md:object-center"
        >
      ...
      <div className="relative flex w-full min-w-0 flex-1 flex-col">
        <SectionContainer className="flex flex-1 flex-col justify-center pb-4 pt-nav sm:pb-6">
          <div className="max-w-2xl min-w-0 space-y-4 sm:space-y-6">
            ...
            <h1 className="hero-headline text-[clamp(1.75rem,5vw,3.75rem)] font-semibold leading-[1.1] tracking-tight sm:text-3xl md:text-5xl lg:text-6xl">
              Power the future of
            ...
            <div className="hero-cta flex flex-wrap items-center gap-3 pt-1 sm:gap-4">
              <a
                href="#features"
                className="group flex w-full min-w-0 items-center justify-center gap-3 rounded-full bg-violet-600 px-6 py-3.5 text-sm font-medium text-white shadow-lg shadow-violet-600/30 transition-all duration-300 hover:bg-violet-500 active:scale-[0.98] sm:w-auto sm:px-8 sm:py-4 sm:text-base"
              >
